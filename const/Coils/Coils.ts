...
export const rightKickerCoil: CoilInfo = { name: 'Right Kicker', id: id(6) };
export const leftKickerCoil: CoilInfo = { name: 'Left Kicker', id: id(7) };
...
export const middleKickerCoil: CoilInfo = { name: 'Middle Kicker', id: id(1) };
